...
#       单页滚动：① ASIN流动性（类目黏性 & 新品活跃表，含 BS 在榜率/满榜率/新增比例、
#       NR 流动率/→BS渗透、MS →BS渗透）；② MS爆发强度（排名提升率排行 + Top20）。
...
#       「只有X个进过BS」废话句；④ BS 在榜率措辞「生命周期越长」(错)→「头部款在榜越持久、轮换慢」。
...
# =======================================================================
# 视角 1：ASIN 流动性（迁移自原独立 ASIN流动性页 类目黏性表）
